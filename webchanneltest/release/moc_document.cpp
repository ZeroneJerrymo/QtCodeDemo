...
QT_MOC_LITERAL(4, 24, 11), // "receiveText"
QT_MOC_LITERAL(5, 36, 6) // "r_text"

    },
    "Document\0sendText\0\0text\0receiveText\0"
    "r_text"
};
...
void Document::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Document::sendText)) {
                *result = 0;
            }
        }
    }
